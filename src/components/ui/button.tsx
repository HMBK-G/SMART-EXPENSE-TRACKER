  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-primary-foreground shadow-md hover:shadow-lg hover:shadow-primary/20",
        accent: "gradient-accent text-accent-foreground shadow-md hover:shadow-lg hover:shadow-accent/20",
        glass: "glass hover:bg-card/90 text-foreground",
        voice: "bg-accent text-accent-foreground shadow-glow hover:shadow-lg animate-pulse-soft",
      },
      size: {
